        ...
        <Html>
            ...
            <Body style={main}>
                <Container style={container}>
                    ...
                    <Section>
                        <Text style={paragraph}>
                            Ce diagnostic vous permet de consulter les réglementations en vigueur ainsi que nos préconisations et conseils techniques adaptés au niveau d'exposition au bruit de votre parcelle.
                        </Text>
                    </Section>
                    <Section>
                        <Text style={paragraph}>
                            <strong>Besoin d'accompagnement ? </strong>
                            Si vous avez des questions complémentaires sur les nuisances sonores ou si vous souhaitez être mis en contact avec un bureau d'études pour une analyse acoustique plus approfondie, notre équipe est là pour vous accompagner. Vous pouvez nous contacter en répondant à cet email.
                        </Text>
                    </Section>
                    <Section>
                        <Text style={paragraph}>
                    ...
                    <Section>
                        <Row>
                            ...
                            <Column align="right" style={footerTextColumn}>
                                ...
                                <Text style={footerText}>
                                    <em>
                                        Service public proposé à titre de conseil pour alerter sur l'exposition sonore des parcelles, réalisé avec l'appui du Cerema et de l'ANCT.
                                    </em>
                                </Text>
                            </Column>
                        </Row>
