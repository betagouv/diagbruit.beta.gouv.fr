...
AGGLO_TERRITORIES: list[AggloTerritory] = [
    ...
    AggloTerritory(
        ...
        files=[
            AggloFile("bruit-aerien-type-a-lden-sur-24h-etude-de-bruit-impedance-ingenierie.shp", "A", "A", "LD"),
            AggloFile("bruit-aerien-type-a-ln-22h-6h-etude-de-bruit-impedance-ingenierie.shp", "A", "A", "LN"),
            AggloFile("bruit-aerien-type-c-lden-sur-24h-etude-de-bruit-impedance-ingenierie.shp", "A", "C", "LD"),
            AggloFile("bruit-industriel-type-a-lden-sur-24h-etude-de-bruit-impedance-ingenierie.shp", "I", "A", "LD"),
            AggloFile("bruit-industriel-type-c-lden-sur-24h-etude-de-bruit-impedance-ingenierie.shp", "I", "C", "LD"),
            AggloFile("bruit-industriel-type-c-ln-22h-6h-etude-de-bruit-impedance-ingenierie.shp", "I", "C", "LN"),
            AggloFile("bruit-routier-type-c-ln-22h-6h-etude-de-bruit-impedance-ingenierie.shp", "R", "C", "LN"),
            AggloFile("fr-observatoire-du-bruit-bruit_isophone_ferroviaire_a_ln.shp", "F", "A", "LN"),
            AggloFile("fr-observatoire-du-bruit-n_bruit_isophone_ferroviaire_c_ln.shp", "F", "C", "LN"),
            ...
            AggloFile("observatoire-du-bruit-n_bruit_isophone_ferroviaire_a_lden.shp", "F", "A", "LD"),
            AggloFile("observatoire-du-bruit-n_bruit_isophone_ferroviaire_c_lden.shp", "F", "C", "LD"),
        ],
    ),
    AggloTerritory(
