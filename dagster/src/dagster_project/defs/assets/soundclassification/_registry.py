...
SOUNDCLASSIFICATION_TERRITORIES: list[SoundclassificationTerritory] = [
    ...
    SoundclassificationTerritory(
        ...
        box_id="410247034834",
        sources=(
            SoundclassificationSource("L_TRONCONS_FER_L_049.shp", mode="fer",
                                      label_from="nomtroncon",
                                      acoustic_category_from="categorie",
                                      acoustic_buffer_from="largeur"),
            SoundclassificationSource("L_TRONCON_ROUTE_L_049.shp", mode="routier",
                                      numero_from="nomtroncon",
                                      acoustic_category_from="categorie",
                                      acoustic_buffer_from="tampon"),
        ),
    ...
    SoundclassificationTerritory(
        ...
        box_id="409688070476",
        sources=(
            SoundclassificationSource("L_Classement_Sonore_Fer_2020_L_072.shp", mode="fer",
                                      label_from="nom_tronco",
                                      acoustic_category_from="categorie_",
                                      acoustic_buffer_from="largeur_se"),
            SoundclassificationSource("L_Classement_Sonore_Routes_2025_L_072.shp", mode="routier",
                                      numero_from="nomroute",
                                      acoustic_category_from="categorie",
                                      acoustic_buffer_from="tampon"),
            SoundclassificationSource("L_Classement_Sonore_Tramway_2016_L_072", mode="tramway",
                                      label_from="nom_tronco",
                                      acoustic_category_from="categorie_",
                                      acoustic_buffer_from="largeur_se"),
        ),
    ...
    SoundclassificationTerritory(
        ...
        box_id="411552088045",
        sources=(
            SoundclassificationSource("troncon_route_validee_85.shp", mode="routier",
                                      numero_from="nomroute",
                                      acoustic_category_from="categorie"),
        ),
    ),
